<div class="header shadow-below">
    ...
    <a href="<?php echo BASE_URL ?>/home.php" class="title">
        Incubator
    </a>

    <?php
        if (isset($_SESSION["MemberId"])) {
            //If a member is logged in then show
    ?>
    <div class="profile" id="header-profile">
        <div class="name">
            <a href="<?php echo BASE_URL ?>/Profile_Page.php">
                <?php echo $member['firstname']." ".$member['lastname'];?>
            </a>
            <div style="display:none" name="memberid">
                <?php echo $member['id']; ?>
            </div>
        </div>
